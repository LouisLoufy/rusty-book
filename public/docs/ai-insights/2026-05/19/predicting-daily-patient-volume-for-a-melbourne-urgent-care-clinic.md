...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/01.png)
*作者生成的图片*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/02.png)
*随时间的每日就诊量*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/03.png)
*天气与疾病驱动因素对就诊量的影响*

*左：按天气类型的日均患者数。雨天略高于晴天。中：患者数与温度。右：花粉指数与患者数，指数到约 7 之前是平的，然后急剧上升（花粉症到哮喘的路径）。*

![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/04.png)
*就诊量的时间模式*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/05.png)
*关键因子对就诊量的影响*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/06.png)
*原始患者计数的右偏分布*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/07.png)
*循环编码*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/08.png)
*自相关函数*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/09.png)
*按疾病驱动因子数量的平均患者数*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/10.png)
*对患者计数的对数变换*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/11.png)
*与患者计数相关性排名前 30 的特征*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/12.png)
*实际与预测的患者计数*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/13.png)
*残差分析*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/14.png)
*SHAP 值*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/15.png)
*对最差预测日单次预测的解释*
...
![](./images/predicting-daily-patient-volume-for-a-melbourne-urgent-care-clinic/16.png)
*带 Bootstrap 区间的预测*
